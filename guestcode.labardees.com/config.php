...
$controllerpassword = 'TheMeatShed19919!'; // the password for access to the UniFi Controller
$controllerurl      = 'https://192.168.1.249:8443'; // full url to the UniFi Controller, eg. 'https://22.22.11.11:8443'
$controllerversion  = '5.6.36'; // the version of the Controller software, eg. '4.6.6' (must be at least 4.0.0)
...
/*
$controllers[0] = [
   'user'     => 'unifi-admin', // the user name for access to the UniFi Controller
   'password' => 'nQordLF3ddbS45aT2EL_p2BhLAHe', // the password for access to the UniFi Controller
   'url'      => 'https://dc1unifi01:8443', // full url to the UniFi Controller, eg. 'https://22.22.11.11:8443'
   'name'     => 'default',
   'version'  => '4.8.20'  // the version of the Controller software, eg. '4.6.6' (must be at least 4.0.0)
];
